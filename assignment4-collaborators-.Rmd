...
## Offence in Australia Each States
```{r crimetype}
...
crime_type %>%
  head() %>%
  kable(booktabs = TRUE, caption = "Four Offfence-types in Each States") %>%
...
```{r offender-by-gender, fig.height=10, fig.width=10, fig.cap="Offenders in Each States by Genders"}
crime_gender %>%
