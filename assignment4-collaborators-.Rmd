...
Having looked at Crime trends around the world and in Australia, let's change tact and now look at Tourism trends. Tourism is critical to the health of the global economy - according to the World Travel and Tourism Council (insert reference later -> https://wttc.org/Research/Economic-Impact), Tourism represents 10.3% of the global GDP and is responsible for creating 1 in 10 jobs around the world. The data will be using is the UN's ['Tourist/visitor arrivals and tourism expenditure'](https://data.un.org/_Docs/SYB/CSV/SYB63_176_202003_Tourist-Visitors%20Arrival%20and%20Expenditure.csv) dataset avaiable on the [UN data webpage](https://data.un.org). The data provides information on Tourism Arrivals (how many tourists arrive in each country) and Tourism Expenditure (the amount of money tourists spend in a country they are visiting). Data was collected in the years 1995, 2005, 2010, 2016, 2017 and 2018. In some instances, a full view of Tourism Arrival and Tourism Expenditure was not available for every single country in all of the years. As such, these countries were removed to preserve the integrity of analysis when comparing global tourism trends from year to year.
...
Figure \@ref(fig:ausvisitpie) is pie chart showing of the cumilative percentage contibution of the tourist arrivals over the years between 199-2018. 22.36%, was a major part of the tourist arrival contibution came in the year 2018 and the least was 9.01% which came in the year 1995. 
...
Figure \@ref(fig:ausexpenpie) is a pie chart comprising of the cumilative expenditure by tourist on their visit to Australia during the respective years. 24.71%, was the highest expenditure contibution by tourist which took place in the year 2018 and 5.41% was the least contribution by tourist in the year 1995. 
