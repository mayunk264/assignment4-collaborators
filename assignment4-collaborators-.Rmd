...
lm_spending_visitor1 <- lm(tour_exp_millionsusd ~ intentional_homicide_rates_per_100_000 +country, data = tour_crime)
lm_spending_visitor2 <- lm(tour_exp_millionsusd ~ visitor_thousands +country, data = tour_crime)
