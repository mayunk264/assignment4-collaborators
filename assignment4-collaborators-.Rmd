...
- In that, international travellers spent an amount of $44.6 billion, which 5% more than the previous year.
(@tour)

On a standardised scale, Figure \@ref(fig:ausbar) is a pictorial representation of the tourist arrivals in and the expenditure contributed by them on their visit to Australia. We can understand, the travel and tourism sector is a major attraction and the results shows the number keep increasing every year. 
