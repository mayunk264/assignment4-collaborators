...
- The average tourist arrivals ranges bewteen 5,000 - 8,000 (thousands). 

```{r boxplot, fig.cap="Boxplot of tourism expenditure and tourist arrivals in Australia"}
Aus_plot %>% 
...
- 47% of visitors arrive in Australia for holiday puropose.

- The median duration of stay in australia is 10 days. (ABS [2019])
