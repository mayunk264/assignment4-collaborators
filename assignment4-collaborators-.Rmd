...
The plot \@ref(fig:crimerates) depicts a column graph with year on the x-axis and counts on the y-axis. Looking at this plot it can be inferred that the rate of crimes in the year 2010 was the highest with a count of more than 750 mean cases throughout the world. Followed by approximate values in 2005, 2015 and 2016 with mean counts of 760, 600 and 500 respectively. Crime is a serious cause for concern and often impacts people's decision to live in certain areas or travel places as in our research question and it also affects the economy of the country. It's a frequent issue for communities, and many other issues can be affected by criminal activity in the area. @universalclass
...
# Conclusion
(Varsha) In conclusion, the crime rates for every country is a problem, it decrease the boost in the economy and with the tables we were able to find that El Salvador was considered to be the most dangerous country in the world both in the years of 2005 and 2016 even though there was a huge gap between the two years for improvement.
