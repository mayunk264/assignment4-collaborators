...
```{r arrivals-plot, fig.cap="Global Tourist Arrivals by Year"}

tourism_clean_world_b %>%
  ggplot(aes(x=Year,y=Global_Yearly_Arrivals)) +
  geom_point() +
  geom_line()
```

```{r expenditure-plot, fig.cap="Global Tourist Expenditure by Year"}

tourism_clean_world_b %>%
  ggplot(aes(x=Year,y=Global_Yearly_Expenditure)) +
  geom_point() +
  geom_line()
